...
export const DEVELOPMENT: Domain = {
  content: `<span class="font-title"><b>níama</b> <span class="text-purple-400">développement</span></span> vous accompagne dans la réalisation de vos applis (desktop, mobile, web).`,
